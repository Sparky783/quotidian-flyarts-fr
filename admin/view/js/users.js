...
var UserManager = {
	...
	Init: function () {		
		$("#addUserButton").click(function(){
			...
			UserManager.currentModal = new bootstrap.Modal(document.getElementById("addUserModal"), {});
			UserManager.currentModal.show();
		});
	...
	AddUser: function(user) {
		...
		actions.find(".modify-user").click(function(){
			...
			UserManager.currentModal = new bootstrap.Modal(document.getElementById("editUserModal"), {});
			UserManager.currentModal.show();
		});
		...
		actions.find(".reinit-user-password").click(function(){
			...
			UserManager.currentModal = new bootstrap.Modal(document.getElementById("reinitUserPasswordModal"), {});
			UserManager.currentModal.show();
		});
		...
		actions.find(".remove-user").click(function(){
			...
			UserManager.currentModal = new bootstrap.Modal(document.getElementById("removeUserModal"), {});
			UserManager.currentModal.show();
		});
